...
<%
    ...
    try {
        ...
        // 날짜 추출
        startDay = jsonObject.get("startDay").toString();
        endDay = jsonObject.get("endDay").toString();
      ...
      //mariaDB 준비
        ...
        // 도시 이름으로 행 가져오기
        sql = "SELECT * FROM kyung128_ts.covidTbl WHERE city=? AND (stdDay>=? AND stdDay<=?)";

        stmt = conn.prepareStatement(sql);
        stmt.setString(1, "합계");
        stmt.setString(2, startDay);
        stmt.setString(3, endDay);
